                        ...
                        <div class="card p-4">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    ...
                                    <label class="me-3 col-md-3 fw-bold text-secondary d-none"
                                        for="individual_bill"><input type="radio" name="bill_type"
                                            value="individual_bill" id="individual_bill" class="me-1"> वैयक्तिक
                                        बिल</label>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-4 ">
                                    ...
                                    <input type="file" class="form-control" name="sarpanch_signature"
                                        id="sarpanch_signature" accept="image/*">
                                </div>
    ...
    <script>
        $(document).ready(function () {
            $('#generatePdfBtn').click(async function () {
                ...
                try {
                    const response = await fetch('pdf/namuna_9_ahaval_register.php', {
                        method: 'POST',
                        body: formData
                    });
