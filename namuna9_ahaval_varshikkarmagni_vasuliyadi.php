                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            <label class="col-md-3 me-4 fw-bold text-primary">
                                <input type="radio" name="criteria" id="milkat_criteria" value="milkat" checked class="me-1 my-2"> मिळकत क्रमांकानुसार
                            </label>
                            <label class="col-md-3 me-4 fw-bold text-primary">
                                <input type="radio" name="criteria" id="ekat_criteria" value="ekat" class="me-1 my-2"> एकत्रीकरण
                            </label>
                             <label class="col-md-3 fw-bold text-primary">
                                <input type="radio" name="criteria" id="all_register" value="all_register" checked class="me-1 my-2"> संपूर्ण रजिस्टर
                            </label>
                            <label class="fw-bold col-md-3 text-primary">
                                <input type="radio" name="criteria" id="gava_mangani" value="gava_mangani" class="me-1 my-2"> गावानुसार मागणी
                            </label>
                             <label class="fw-bold col-md-3 text-primary">
                                <input type="radio" name="criteria" id="malmatta_mangani" value="malmatta_mangani" class="me-1 my-2"> मालमत्तेनुसार मागणी
                            </label>
                        </div>
