                                ...
                                <div class="card-body">
                                    ...
                                    <form method="post" action="api/checkbook.php">
                                        ...
                                        <div class="row" >
                                            ...
                                            <div class="form-group col-md-6">
                                                <label for="checkbook_no">चेकबुक क्रमांक <span class="text-danger">*</span>
                                                </label>
                                               <input type="text" name="checkbook_no" id="checkbook_no" class="form-control" placeholder="चेकबुक क्रमांक" required>
    
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="first_check_no">पहिला चेक क्रमांक <span class="text-danger">*</span>
                                                </label>
                                            ...
                                            <div class="form-group col-md-6">
                                               ...
                                               <input type="text" name="check_no" id="check_no" class="form-control" placeholder="चेक संख्या" required>
    
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="last_check_no">शेवटचा चेक क्रमांक <span class="text-danger">*</span>
                                                </label>
                                               <input type="text" name="last_check_no" id="last_check_no" class="form-control" readonly placeholder="शेवटचा चेक क्रमांक" required>
...
function fillCheckbookData(id, plan_name, bank_id, checkbook_no, first_check_no, check_no, last_check_no, date) {
    ...
    // Scroll to form
    document.getElementById('plan_name').scrollIntoView({ behavior: 'smooth' });
}
