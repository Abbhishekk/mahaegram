            ...
            <div id="content">
                ...
                <div class="container-fluid" id="container-wrapper">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">पुनर्विनियोजन व निपटवाटप</h1>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="./">Home</a></li>
                            <li class="breadcrumb-item active" aria-current="page">नमुना क्रमांक 2</li>
                            <li class="breadcrumb-item active" aria-current="page">पुनर्विनियोजन व निपटवाटप</li>
                        </ol>
                    </div>
                    ...
                    <div class="card p-4">
                        <form method="post" action="process.php">
                            ...
                            <div class="form-group">
                                <label for="fund_name">फंडाचे नाव <span class="text-danger">*</span></label>
                                <select class="form-control" name="fund_name" id="fund_name" required>
                                    <option value="">Select</option>
