...
<html lang="en">
<?php 
$title = "पावती पुस्तक नोंदणी /वितरण";
?>
            ...
            <div id="content">
                ...
                <div class="container-fluid" id="container-wrapper">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">पावती पुस्तक नोंदणी /वितरण</h1>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">पावती पुस्तक नोंदणी /वितरण</li>
                        </ol>
                    </div>
