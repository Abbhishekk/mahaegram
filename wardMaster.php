...
<div class="row mb-3">
    <div class="col-lg-12">
        <div class="card shadow mb-4">
            <div class="card-header py-3 bg-primary">
                <h6 class="m-0 font-weight-bold text-white">वॉर्ड व्यवस्थापन</h6>
            </div>
            <div class="card-body">
                <?php
                ...
                <form method="post" action="api/ward.php">
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control border-primary" name="ward_name" id="ward_name" 
                               placeholder="वॉर्डचे नाव" required>
                        <label for="ward_name">वॉर्डचे नाव <span class="text-danger">*</span></label>
                        <input type="number" value="" class="form-control d-none" name="ward_no" id="ward_no">
    ...
    <div class="col-lg-12">
        <div class="card shadow">
            <div class="card-header py-3 bg-primary">
                <h6 class="m-0 font-weight-bold text-white">वॉर्ड यादी</h6>
            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="#" class="text-primary" 
                                   onclick="filldata('<?php echo $ward['ward_no']; ?>', '<?php echo $ward['ward_name']; ?>')">
