        ...
        <option value=""> -- प्रथम योजना निवडा -- </option>
                                            ...
                                            <div class="form-group col-md-6">
                                                <label for="check_book_no">चेक बूक नंबर: <span
                                                        class="text-danger">*</span></label>
                                                <select class="form-control" name="check_book_no" id="check_book_no" required>
                                                    <option value="">--निवडा--</option>
                                                        <?php  
                                             ...
                                             <div class="form-group col-md-6">
                                                <label for="check_no">चेक नंबर : <span
                                                        class="text-danger">*</span> </label>
                                            ...
                                            <div class="form-group col-md-6">
    <label for="bank_name2">बँकेचे नाव <span class="text-danger">*</span></label>
    <select class="form-control mb-3" name="bank_name_to_deposit" id="bank_name2" required >
        <option value=""> -- प्रथम योजना निवडा -- </option>
    </select>
</div>
 <div class="form-group col-md-6">
                                                <label for="to_deposit_account_balance">खात्यातील शिल्लक रक्कम :</label>
                                                <input type="text" name="to_deposit_account_balance" id="to_deposit_account_balance"
                                                    class="form-control" >
                                            </div>
...
$('button[type="reset"]').click(function() {
    $('#bank_bharane_id').val('');
    $('#bank_name, #bank_name2').html('<option value="">-- प्रथम योजना निवडा --</option>').prop('disabled', true);
