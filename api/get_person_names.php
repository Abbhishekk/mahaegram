...
try {
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $panchayatCode = $_SESSION['district_code'];

        $query = "SELECT DISTINCT  nn1.person_name as `kar_denaryache_nav`, nn2.person_name as `occupant` 
        ...
        LEFT outer join new_name nn2 on mde.occupant_name = nn2.id
                  ...
                  AND kr.kar_denaryache_nav IS NOT NULL";
